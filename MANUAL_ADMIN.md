...
2. **Logo de la Empresa**: Suba el logo de su empresa. Se usará como respaldo en los recibos cuando el propietario no tenga logo propio.
3. **Datos de la Empresa**: Configure el nombre, RIF y teléfono. Estos datos aparecen en el pie de página de los recibos impresos.
4. **Configuración de Perfil**: Actualice su nombre de usuario y correo.
